...
images_l = glob.glob('./StereoCalibration/images/LEFT/b8/*.jpg')
images_r = glob.glob('./StereoCalibration/images/RIGHT/b8/*.jpg')
...
np.savetxt('./StereoCalibration/Params/Rotation.csv', R, fmt='%f', delimiter=',')
np.savetxt('./StereoCalibration/Params/Trans.csv', T, fmt='%f', delimiter=',')
np.savetxt('./StereoCalibration/Params/L_matrix.csv', cameraMatrix1, fmt='%f', delimiter=',')
np.savetxt('./StereoCalibration/Params/L_dist.csv', distCoeffs1, fmt='%f', delimiter=',')
np.savetxt('./StereoCalibration/Params/R_matrix.csv', cameraMatrix2, fmt='%f', delimiter=',')
np.savetxt('./StereoCalibration/Params/R_dist.csv', distCoeffs2, fmt='%f', delimiter=',')