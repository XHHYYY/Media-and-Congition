...
if __name__ == '__main__':
    # 读取MiddleBurry数据集的图片
    iml = cv2.imread('./StereoCalibration/images/LEFT/b8/2 baseline = 8.jpg', 1)  # 左图
    imr = cv2.imread('./StereoCalibration/images/RIGHT/b8/2 baseline = 8.jpg', 1)  # 右图
    ...
    cv2.imwrite('./StereoCalibration/images/Line.jpg', line)
    ...
    cv2.imwrite('./StereoCalibration/images/disparity.jpg', disp * 4) 
